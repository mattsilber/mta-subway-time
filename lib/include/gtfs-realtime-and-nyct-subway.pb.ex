...
defmodule TransitRealtime.TripReplacementPeriod do
  ...
  field :route_id, 1, optional: true, type: :string
  field :replacement_period, 2, optional: true, type: TransitRealtime.TimeRange
end
...
defmodule TransitRealtime.NyctFeedHeader do
  ...
  field :nyct_subway_version, 1, required: true, type: :string
  field :trip_replacement_period, 2, repeated: true, type: TransitRealtime.TripReplacementPeriod
end
...
defmodule TransitRealtime.NyctTripDescriptor do
  ...
  field :train_id, 1, optional: true, type: :string
  field :is_assigned, 2, optional: true, type: :bool
...
defmodule TransitRealtime.NyctStopTimeUpdate do
  ...
  field :scheduled_track, 1, optional: true, type: :string
  field :actual_track, 2, optional: true, type: :string
end
...
defmodule TransitRealtime.PbExtension do
  ...
  extend TransitRealtime.FeedHeader, :nyct_feed_header, 1001,
    optional: true,
    type: TransitRealtime.NyctFeedHeader
